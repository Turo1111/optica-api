...
router.patch('/updateprice/:idProducto', function(req, res) {
    try {
        isAuth(req.headers.authorization)
            .then(decoded => {
                if (decoded.error) {
                ...
                controller.patchUpdatePrice(req.params.idProducto, req.body)
                .then(data => {
                    emitSocket('stock', {
                        action: 'patch',
                        res: req.body
...
router.patch('/sinid', function(req, res) {
    try {
        isAuth(req.headers.authorization)
            .then(decoded => {
                if (decoded.error) {
                ...
                controller.patchSinId(req.body)
                .then(data => {
                    emitSocket('stock', {
                        action: 'patch',
                        res: req.body
